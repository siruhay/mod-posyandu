...
use Module\Posyandu\Http\Resources\RecipientResource;

class PosyanduRecipient extends Model
{
    use Filterable;
    use HasMeta;
    use HasPageSetup;
     ...
     * @var string
     */
    protected $table = 'posyandu_recipients';
     ...
     * @var array
     */
    protected $roles = ['posyandu-recipient'];
